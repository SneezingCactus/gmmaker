...
export default {
  init: function() {
    ...
    this.modePSON = new window.dcodeIO.PSON.ProgressivePair(this.blocklyCompressDict);
    this.initGMEditor();
  },
  ...
  funcs: {
    ...
    changeVar: function(varName, gameState, discID, value) {
      ...
      if (varName.startsWith('GLOBAL_')) {
        ...
        if (!gameState.gmExtra.variables[discID][varName]) gameState.gmExtra.variables[discID][varName] = 0;
        gameState.gmExtra.variables[discID][varName] += value;
      }
    },
