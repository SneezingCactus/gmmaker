...
export default {
  ...
  rules: [
    {key: 'editor', name: 'Editor', content: [
      {type: 'boolean', key: 'darkWorkspace', text: 'Dark workspace (meant for use alongside Bonk Themes or Bonk Leagues Client)', default: false},
    ...
    {key: 'ingame', name: 'In-game', content: [
      ...
      {type: 'boolean', key: 'allowSounds', text: 'Allow modes to play sounds', default: true},
    ]},
