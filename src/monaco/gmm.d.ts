...
declare interface swingInfo {
  /**
   * Attached platform's ID.
   */
  public b: number;
  /**
   * Grappling point relative to the attached platform's position.
   */
  public p: vector2d;
  /**
   * Grapple rod length.
...
interface physShapeList {
  [index: number]: physShape;
}
...
declare interface platform {
  ...
  public type: 's' | 'k' | 'd';
  /**
   * Position of the platform, as a 2d vector.
   * 
   * Read more about vectors [here](https://sneezingcactus.github.io/gmmaker/docs/tutorials/Fundaments-3.html).
   */
  public p: vector2d;
  /**
   * Linear velocity of the platform, as a 2d vector.
   * 
   * Read more about vectors [here](https://sneezingcactus.github.io/gmmaker/docs/tutorials/Fundaments-3.html).
   */
  public lv: vector2d;
  /**
   * Angle in degrees of the platform.
   */
  public a: number;
  /**
  ...
  public av: number;
  /**
   * `true` if this platform can apply friction on players (Fric players), `false` otherwise.
   */
  public fricp: boolean;
  /**
   * Friction of the platform surface.
   */
  public fric: number;
  /**
  ...
  public de: number;
  /**
   * Restitution (bounciness) of the platform.
   */
  public re: number;
  /**
   * The amount of linear drag on the platform.
   */
  public ld: number;
  /**
   * The amount of angular drag on the platform.
   */
  public ad: number;
  /**
   * `true` if this platform has a fixed rotation, `false` otherwise.
   */
  public fr: boolean;
  /**
   * `true` if this platform has bullet physics (Anti Tunnel), `false` otherwise.
   */
  public bu: boolean;
  /**
   ...
   * 
   * NOTE: This is not an ordinary array! You can't manually add or remove shapes from this object. You
   * must use the `game.world.addShapeToPlat` and `game.world.removeShapeFromPlat` methods.
   */
  public shapes: physShapeList;
  /**
   * The collision group of the platform.
   * 
  ...
  public f_c: 1 | 2 | 3 | 4;
  /**
   * `true` if this platform can collide with players, `false` otherwise.
   */
  public f_p: boolean;
  /**
   * `true` if this platform can collide with group A, `false` otherwise.
   */
  public f_1: boolean;
  /**
   * `true` if this platform can collide with group B, `false` otherwise.
   */
  public f_2: boolean;
  /**
   * `true` if this platform can collide with group C, `false` otherwise.
   */
  public f_3: boolean;
  /**
   * `true` if this platform can collide with group D, `false` otherwise.
   */
  public f_4: boolean;
  /**
   * Determines whether the platform is visible or not.
   */
  public visible: boolean;
}
 ...
 */
declare interface physShape {
  /**
   * The shape's geometry parameters.
   */
  public geo: physShapeGeometry;
  /**
   * Name of the shape.
   */
  public n: string;
  ...
  public f: number;
  /**
   * `true` if this shape can apply friction on players (Fric players), `false` otherwise.
   * 
   * If set to `null`, the platform's fric players will be used here.
   */
  public fp: boolean | null;
  /**
   * Friction of the shape's surface. If set to `null`, the platform's friction will be used here.
   */
  public fr: number | null;
  /**
   * Restitution (bounciness) of the shape. If set to `null`, the platform's restitution will be used here.
   */
  public re: number | null;
  /**
   * Density of the shape. If set to `null`, the platform's density will be used here.
   */
  public de: number | null;
  /**
   * `true` if this shape can kill players, `false` otherwise.
   */
  public d: boolean;
  /**
   * `true` if this shape is no physics, `false` otherwise.
   */
  public np: boolean;
  /**
   * `true` if this shape can't be grappled, `false` otherwise.
   */
  public ng: boolean;
  /**
   * `true` if this shape can be grappled from the inside, `false` otherwise.
   */
  public ig: boolean;
}

/**
 * Definition of a shape's geometry data.
 */
declare interface physShapeGeometry {
  /**
   * Geometry type. 
   * 
   * Can be:
...
declare interface joint {
  ...
  public bb: number;
  /**
   * [Rotating and soft rod only] First attachment offset, as a 2d vector. Relative to the first attachment's platform.
   * 
   * Read more about vectors [here](https://sneezingcactus.github.io/gmmaker/docs/tutorials/Fundaments-3.html).
   */
  public aa: vector2d;
  /**
   * [Rotating and soft rod only] Second attachment offset, as a 2d vector. Relative to the second attachment's platform.
   * If there's no specified second platform (bb == -1), it's absolute (relative to world) instead.
   * 
   * Read more about vectors [here](https://sneezingcactus.github.io/gmmaker/docs/tutorials/Fundaments-3.html).
   */
  public ab: vector2d;
...
/**
 * This is where map platforms and joints are stored.
 */
declare interface statePhysics {
  /**
   * Array that contains the definitions of every platform in the world.
   * 
   * Ordered by ID (platform[0] is platform with ID 0, platform[2] is platform with ID 2, etc.)
   * 
   * NOTE: This is not an ordinary array! You can't manually add or remove platforms from this object. You
   * must use the `game.world.createPlatform` and `game.world.removePlatform` methods.
   */
  public platforms: platformList;
  /**
   ...
   * 
   * Each item contains a platform ID: the first platform in the list is the one that gets rendered first
   * (and as such is the farthest platform from the camera) and the last platform in the list is the one
   * that renders last (and as such is the nearest platform).
   */
  public bro: number[];
  /**
...
declare interface collisionEventOptions {
  /**
   * Indicates what collision needs to happen for the event to fire: collision with a player, an arrow or a platform.
   */
  public collideWith: 'disc' | 'arrow' | 'platform';
}
 ...
 * 
 */
declare interface collisionEvent_platform extends collisionEventOptions {
  public collideWith: 'platform';
}

/**
 * Additional collision data that only platform collisions possess.
 */
declare interface platformCollisionData {
  /**
   * ID of the platform hit.
   */
  public id: number;
  /**
   * Index of the platform shape hit.
   */
...
declare interface gameEvents {
  ...
  public addEventListener(eventName: 'discCollision', options: collisionEvent_platform, listener: (discId: number, collisionData: platformCollisionData) => void)
  ...
  public addEventListener(eventName: 'arrowCollision', options: collisionEvent_platform, listener: (arrowId: number, collisionData: platformCollisionData) => void)

  public addEventListener(eventName: 'platformCollision', options: collisionEvent_disc, listener: (platformData: platformCollisionData, collisionId: number) => void)
  public addEventListener(eventName: 'platformCollision', options: collisionEvent_arrow, listener: (platformData: platformCollisionData, collisionId: number) => void)
  public addEventListener(eventName: 'platformCollision', options: collisionEvent_platform, listener: (platformData: platformCollisionData, collisionData: platformCollisionData) => void)
}
...
declare interface drawing {
   ...
   * 
   * "platform" attaches the drawing to a platform. Position and angle of the platform affects it. The drawing can appear in front of/behind the specified platform. This option requires you to put the platform's ID in attachId. 
   */
  public attachTo: 'screen' | 'world' | 'disc' | 'platform';
  /**
   * An ID, used by the "disc" and "platform" attachment types.
   */
...
declare interface rayCastResult {
   ...
   */
  public type: 'disc' | 'arrow' | 'platform';
  /**
   * ID of the object.
   */
  public id: number;
  ...
  public normal: vector2d;
  /**
   * [Platform type hits only] Index of the platform shape hit by the raycast.
   */
  public shapeIndex: number;
  /**
...
declare interface gameWorld {
   ...
   * Create a platform.
   * 
   * @param viewOrder - Indicates where in game.state.physics.bro the platform ID should be placed. In other words, it indicates the layer at which the platform will be drawn, where the layer with the biggest number is the farthest layer, and the layer with the smallest number (down to 0) is the nearest layer. If you set this to null, the platform will be placed at the nearest layer (0).
   * @param platformDef - The platform to be created. It's not necessary to specify every property of the platform here, any missing properties will be replaced with default values, so you can remove property definitions for stuff you don't need. For example: velocity, drag, fixed rotation, apply forces, and some others are not sed on static platforms, so you can remove those when creating one.
   ...
   * @param shapeDef - The shape to be added. It's not necessary to specify every property of the shape here, any missing properties will be replaced with default values, so you can remove property definitions for stuff you don't need. For example: physical properties, as well as death, no grapple and inner grapple are not used in a no-physics shape, so you can remove those when defining one.
   * @returns {number} The index at which the shape is located in the platform's `shapes` array.
   */
  public addShapeToPlat(platId: number, shapeDef: physShape): number;
  /**
   ...
   */
  public movePlatShape(platId: number, fromIndex: number, toIndex: number);
  /**
   * Remove a shape from a platform.
   * @param platId - The ID of the platform
   * @param shapeIndex - The index of the shape to be removed
   */
  public removeShapeFromPlat(platId: number, shapeIndex: number);
  /**
   * Delete the specified platform, and everything related to it, such as joints and capzone definitions. Drawings attached to the platform aren't deleted.
   * 
   ...
   * End the round.
   * 
   * If teams are off, the win will correspond to the player with the specified id.
   * 
   ...
   * 
   * Note: the shapeIndex and isCapzone properties in the hit results are only for type platform hits,
...
namespace Colour {
  ...
  /**
   * Turn red, green and blue into a hex colour to use in drawings, platform shapes, etc.
   * 
