import { safeAtan2, safeCos, safeSin } from './math';
...
export default function defineApiVector(): APIVector {
  ...
  return harden({
    ...
    rotate2d: (v, a) => [
      v[0] * safeCos(a) - v[1] * safeSin(a),
      v[0] * safeSin(a) + v[1] * safeCos(a),
    ],
    getAngle2d: v => -safeAtan2(v[0], v[1]) + 90,
  });
}
